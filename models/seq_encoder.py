...
class SeqEncoder(nn.Module):
    ...
    def forward(self, input_ids, attention_mask):
        ...
        sequence_output, _ = process_long_input(self.bert, input_ids, attention_mask, start_tokens, end_tokens)
        
        return sequence_output
    
def process_long_input(model, input_ids, attention_mask, start_tokens, end_tokens):
    # Process long sequence script from https://github.com/wzhouad/ATLOP/tree/main
