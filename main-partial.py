...
from metric import metric, num_metric, overlap_metric, t_test
...
class Trainer:
    ...
    def eval_epoch(self, dataloader):
        ...
        num_metric_scores = num_metric(prediction, gold)
        overlap_metric_scores = overlap_metric(prediction, gold)

        return avg_loss, eval_scores, num_metric_scores, overlap_metric_scores
    ...
    def train(self):
        for epoch in range(self.args.epochs):
            ...
            wandb.log({"train_loss": avg_train_loss, 
                       ...
                       "val_f1_gt1": num_metric_scores[0]['f1'],
                       "val_f1_gt2": num_metric_scores[1]['f1'],
                       "val_f1_gt3": num_metric_scores[2]['f1'],
                       "val_f1_gt4": num_metric_scores[3]['f1'],
                       "val_f1_gt5": num_metric_scores[4]['f1'],
                       "val_f1_norm": overlap_metric_scores[0]['f1'],
                       "val_f1_epo": overlap_metric_scores[1]['f1'],
                       "val_f1_seo": overlap_metric_scores[2]['f1'],
                       "epoch": epoch})
...
def main():
    ...
    parser.add_argument("--data_type", type=str, default="NYT-Partial")
    ...
    parser.add_argument('--decoder_lr', type=float, default=8e-5)
    ...
    parser.add_argument("--project", type=str, default="NYTPartial-ACL")
    ...
    if args.data_type == "NYT-Partial":
        args.num_classes = 25
    elif args.data_type == "WebNLG-Partial":
        args.num_classes = 171
    else:
